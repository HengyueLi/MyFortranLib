...
!
! avalable gets:
!                  [sub] get_G(sitei,spini,sitej,Nomega,Omega,G)
!!$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
 ...
 contains
    ...
    SUBROUTINE get_xw_real(self,xs,xe,x,w)
        ...
        select case(self%typecase)
            case(0_8)
                do jc=1_8,self%TOTN
                   call PARAMETER_FOR_INTERGRAN2015_HO(int(self%TOTN,4),int(self%TOTN,4)-int(jc,4)+1,X(jc),W(jc))
                end do
            case(1_8)
                do jc=1_8,self%TOTN
    ...
    SUBROUTINE get_xw_complex(self,xs,xe,x,w)
        ...
        select case(self%typecase)
            case(0_8)
                do jc=1_8,self%TOTN
                   call PARAMETER_FOR_INTERGRAN2015_HO(int(self%TOTN,4),int(self%TOTN,4)-int(jc,4)+1,Xt(jc),Wt(jc))
                end do
            case(1_8)
                do jc=1_8,self%TOTN
...
SUBROUTINE PARAMETER_FOR_INTERGRAN2015_HO(N,I,XI,WI)  !
IMPLICIT NONE
INTEGER::N,I   ;REAL(8)::XI,WI,delta
delta=2._8/N
...
WI=2.0_8*(1.0_8-XI**2)/(LEGENDRE2015(N+1,XI)*(N+1))**2
ENDSUBROUTINE
...
ZERO_FOR_LEGENDRE2015=COS(  (4.0_8*I-1.0_8)/(4.0_8*N+2)*3.14159265358979  )
...
FUNCTION DE_FOR_LEGENDRE2015(N,X,RE)
    ...
    DE_FOR_LEGENDRE2015=n*(x*LEGENDRE2015(N,X) - LEGENDRE2015(N-1,X) )/(x**2-1._8)
    ENDfunction
